-- Ava Recruit — canonical schema (mirror of supabase/migrations, applied in order).
-- Source of truth is supabase/migrations; this file is a readable snapshot.
...
ALTER PUBLICATION supabase_realtime ADD TABLE public.call_sessions;ALTER TABLE public.interview_schedules
